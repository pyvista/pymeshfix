...
int abstractHeap::upheap(int k)
{
 ...
 if (compare(t, f) <= 0)
 {
  ...
  if (positions != NULL)
  {
   positions[reinterpret_cast<intptr_t>(f)] = k;
   positions[reinterpret_cast<intptr_t>(t)] = fk;
  }
  return upheap(fk);
 }
 return k;
...
int abstractHeap::downheap(int k)
{
 ...
 if (compare(t, f) >= 0)
 {
  ...
  {
      positions[reinterpret_cast<intptr_t>(f)] = k;
      positions[reinterpret_cast<intptr_t>(t)] = j;
  }
  return downheap(j);
 }
...
int abstractHeap::insert(void *t)
{
 ...
 heap[++numels] = t;
 if (positions != NULL) positions[reinterpret_cast<intptr_t>(t)] = numels;
...
{
 void *t = heap[1];
 if (positions != NULL) positions[reinterpret_cast<intptr_t>(t)] = 0;
 heap[1] = heap[numels--];
 if (numels)
 {
     if (positions != NULL) positions[reinterpret_cast<intptr_t>(heap[1])] = 1;
  downheap(1);
 }
